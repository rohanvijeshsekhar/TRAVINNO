import{a as e}from"./rolldown-runtime-Cyuzqnbw.js";import{Dt as t,a as n,g as r,kt as i,m as a,r as o,t as s,u as c}from"./vendor-D2zT6KuG.js";import{a as l,i as u}from"./vendor-framer-DHttXlW5.js";var d=e(i(),1),f=t(),p=[{id:1,title:`Senior Travel Consultant`,location:`Dubai, UAE`,type:`Full-Time`,description:`Help create premium leisure and corporate travel experiences for global clients.`,status:`Open`},{id:2,title:`Operations & Destination Coordinator`,location:`Cochin, India`,type:`Full-Time`,description:`Coordinate ground logistics, hotel contracts, and transit operations for luxury tours.`,status:`Open`},{id:3,title:`Luxury Travel Representative`,location:`Bangkok, Thailand`,type:`Contract`,description:`Deliver bespoke local guiding, transfer coordination, and VIP guest relations.`,status:`Open`},{id:4,title:`Digital Marketing Lead`,location:`London, UK`,type:`Full-Time`,description:`Direct digital brand strategies, campaigns, and audience growth across global luxury sectors.`,status:`Closed`}];function m(){let[e]=(0,d.useState)(p),[t,i]=(0,d.useState)(null),[m,h]=(0,d.useState)(!1),[g,_]=(0,d.useState)(null),[v,y]=(0,d.useState)(!1),[b,x]=(0,d.useState)({fullName:``,email:``,phone:``,coverLetter:``}),[S,C]=(0,d.useState)({}),w=e.filter(e=>e.status===`Open`);(0,d.useEffect)(()=>(m?document.body.style.overflow=`hidden`:document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[m]),(0,d.useEffect)(()=>{let e=e=>{e.key===`Escape`&&m&&E()};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[m]);let T=(e=null)=>{i(e),h(!0),y(!1),_(null),x({fullName:``,email:``,phone:``,coverLetter:``}),C({})},E=()=>{h(!1),i(null)},D=e=>{let t=e.target.files[0];t&&(t.size>5*1024*1024?(C(e=>({...e,file:`File exceeds the maximum size limit of 5MB.`})),_(null)):(_(t),C(e=>{let t={...e};return delete t.file,t})))},O=(e,t)=>{x(n=>({...n,[e]:t})),S[e]&&C(t=>{let n={...t};return delete n[e],n})};return(0,f.jsxs)(`div`,{style:{backgroundColor:`#050505`,color:`#F5F2EC`,width:`100%`,minHeight:`100vh`,position:`relative`,overflowX:`hidden`,boxSizing:`border-box`},children:[(0,f.jsx)(`style`,{children:`
      ...
      `}),(0,f.jsx)(`div`,{style:{position:`absolute`,inset:0,backgroundColor:`#050505`,zIndex:0,pointerEvents:`none`}}),(0,f.jsx)(`div`,{style:{position:`absolute`,inset:0,backgroundImage:`
            linear-gradient(rgba(245, 242, 236, 0.04) 1px, transparent 1px),
            linear-gradient(90deg, rgba(245, 242, 236, 0.04) 1px, transparent 1px)
          `,backgroundSize:`50px 50px, 50px 50px`,backgroundRepeat:`repeat, repeat`,zIndex:2,pointerEvents:`none`}}),(0,f.jsx)(`div`,{className:`hero-artwork-container`,style:{position:`absolute`,right:0,top:0,width:`54%`,height:`580px`,pointerEvents:`none`,zIndex:1,overflow:`hidden`,WebkitMaskImage:`linear-gradient(to right, transparent 0%, black 70%)`,maskImage:`linear-gradient(to right, transparent 0%, black 70%)`},children:(0,f.jsx)(u.div,{animate:{y:[0,-3,0]},transition:{duration:6,ease:`easeInOut`,repeat:1/0},style:{width:`100%`,height:`100%`,position:`relative`},children:(0,f.jsx)(`img`,{src:`/TRAVINNO/images/careers_hero.png`,alt:`Executive Workspace Editorial`,style:{width:`100%`,height:`100%`,objectFit:`cover`,opacity:.38,filter:`grayscale(100%) contrast(80%) brightness(65%)`,transition:`opacity 0.5s ease`,WebkitMaskImage:`linear-gradient(to bottom, black 82%, transparent 100%)`,maskImage:`linear-gradient(to bottom, black 82%, transparent 100%)`}})})}),(0,f.jsxs)(`div`,{className:`careers-container`,children:[(0,f.jsx)(`section`,{style:{marginBottom:`24px`,position:`relative`},children:(0,f.jsxs)(`div`,{style:{maxWidth:`640px`,position:`relative`,zIndex:3},children:[(0,f.jsxs)(u.span,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.8,ease:[.16,1,.3,1]},style:{display:`inline-flex`,alignItems:`center`,gap:`6px`,padding:`4px 12px`,border:`1px solid rgba(193, 18, 31, 0.18)`,borderRadius:`100px`,fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:500,letterSpacing:`0.05em`,color:`rgba(245, 242, 236, 0.85)`,marginBottom:`16px`,background:`rgba(193, 18, 31, 0.05)`,backdropFilter:`blur(4px)`,WebkitBackdropFilter:`blur(4px)`},children:[(0,f.jsx)(`span`,{style:{width:`6px`,height:`6px`,backgroundColor:`#C1121F`,borderRadius:`50%`,display:`inline-block`}}),`Careers`]}),(0,f.jsxs)(u.h1,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,ease:[.16,1,.3,1],delay:.1},style:{fontFamily:`var(--font-heading)`,fontSize:`clamp(2.2rem, 5vw, 3.8rem)`,fontWeight:450,lineHeight:1.15,color:`#F5F2EC`,margin:`0 0 16px 0`,letterSpacing:`-0.5px`},children:[`Build Extraordinary `,(0,f.jsx)(`br`,{}),(0,f.jsx)(`span`,{style:{fontFamily:`'Allura', cursive`,fontSize:`1.25em`,fontWeight:400,letterSpacing:`0.02em`,lineHeight:`1.2`,display:`inline-block`,marginTop:`-4px`,paddingBottom:`0px`,background:`linear-gradient(to bottom, #F5F2EC 20%, #E8A7A7 60%, #C1121F 100%)`,WebkitBackgroundClip:`text`,WebkitTextFillColor:`transparent`,backgroundClip:`text`},children:`Journeys With Us`})]}),(0,f.jsx)(u.p,{initial:{opacity:0,y:10},animate:{opacity:.75,y:0},transition:{duration:.8,ease:[.16,1,.3,1],delay:.2},style:{fontFamily:`var(--font-sans)`,fontSize:`clamp(1rem, 1.8vw, 1.2rem)`,lineHeight:1.65,color:`#F5F2EC`,margin:0,maxWidth:`680px`,fontWeight:300},children:`Join a passionate team creating exceptional travel experiences across global destinations. At Travinno, every role contributes to unforgettable journeys.`})]})}),(0,f.jsxs)(`section`,{style:{position:`relative`},children:[(0,f.jsxs)(u.div,{initial:{opacity:0,y:15},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.8,ease:[.16,1,.3,1]},style:{display:`inline-flex`,alignItems:`center`,gap:`6px`,padding:`4px 12px`,border:`1px solid rgba(193, 18, 31, 0.18)`,borderRadius:`100px`,fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:500,letterSpacing:`0.05em`,color:`rgba(245, 242, 236, 0.85)`,marginBottom:`16px`,background:`rgba(193, 18, 31, 0.05)`,backdropFilter:`blur(4px)`,WebkitBackdropFilter:`blur(4px)`},children:[(0,f.jsx)(`span`,{style:{width:`6px`,height:`6px`,backgroundColor:`#C1121F`,borderRadius:`50%`,display:`inline-block`}}),`Available Opportunities`]}),w.length>0?(0,f.jsx)(`div`,{className:`job-card-grid`,children:w.map((e,t)=>(0,f.jsxs)(u.div,{className:`premium-job-card`,initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:`-50px`},transition:{duration:.8,ease:[.16,1,.3,1],delay:t*.05},children:[(0,f.jsxs)(`div`,{className:`job-card-info`,children:[(0,f.jsxs)(`div`,{className:`job-card-meta`,children:[(0,f.jsxs)(`div`,{className:`meta-item`,children:[(0,f.jsx)(n,{size:13,style:{color:`#C1121F`}}),(0,f.jsx)(`span`,{children:e.location})]}),(0,f.jsx)(`span`,{children:`•`}),(0,f.jsxs)(`div`,{className:`meta-item`,children:[(0,f.jsx)(a,{size:13,style:{color:`rgba(245, 242, 236, 0.5)`}}),(0,f.jsx)(`span`,{children:e.type})]})]}),(0,f.jsx)(`h3`,{className:`job-card-title`,children:e.title})]}),(0,f.jsx)(`p`,{className:`job-card-desc`,children:e.description}),(0,f.jsx)(`div`,{className:`job-card-action`,children:(0,f.jsxs)(`button`,{onClick:()=>T(e),className:`premium-apply-btn`,children:[`Apply Now `,(0,f.jsx)(r,{size:13})]})})]},e.id))}):(0,f.jsxs)(u.div,{initial:{opacity:0,scale:.98},whileInView:{opacity:1,scale:1},viewport:{once:!0},transition:{duration:.8,ease:[.16,1,.3,1]},style:{textAlign:`center`,padding:`80px 40px`,border:`1px solid rgba(245, 242, 236, 0.06)`,borderRadius:`20px`,background:`rgba(255, 255, 255, 0.005)`},children:[(0,f.jsx)(`h3`,{style:{fontFamily:`var(--font-heading)`,fontSize:`1.8rem`,fontWeight:500,margin:`0 0 12px 0`,color:`#F5F2EC`},children:`No Current Openings`}),(0,f.jsx)(`p`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.96rem`,color:`rgba(245, 242, 236, 0.55)`,margin:`0 0 32px 0`,fontWeight:300},children:`We’re always looking for exceptional talent. Check back soon for future opportunities.`}),(0,f.jsxs)(`button`,{onClick:()=>T(null),className:`premium-apply-btn`,style:{margin:`0 auto`},children:[`Send Your Resume `,(0,f.jsx)(r,{size:13})]})]})]})]}),(0,f.jsx)(l,{children:m&&(0,f.jsx)(`div`,{className:`modal-overlay`,onClick:E,children:(0,f.jsxs)(u.div,{className:`modal-content`,initial:{opacity:0,scale:.95,y:20},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:15},transition:{duration:.4,ease:[.16,1,.3,1]},onClick:e=>e.stopPropagation(),children:[(0,f.jsx)(`button`,{className:`modal-close-btn`,onClick:E,"aria-label":`Close Modal`,children:(0,f.jsx)(s,{size:20})}),v?(0,f.jsxs)(u.div,{initial:{opacity:0,scale:.97},animate:{opacity:1,scale:1},style:{textAlign:`center`,padding:`30px 10px`,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`20px`},children:[(0,f.jsx)(c,{size:56,style:{color:`#C1121F`}}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h2`,{style:{fontFamily:`var(--font-heading)`,fontSize:`1.8rem`,fontWeight:500,color:`#F5F2EC`,margin:`0 0 10px 0`},children:`Application Received`}),(0,f.jsx)(`p`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.94rem`,color:`rgba(245, 242, 236, 0.65)`,lineHeight:1.6,maxWidth:`380px`,margin:`0 auto`,fontWeight:300},children:`Thank you for applying. A member of our luxury coordination team will review your CV and be in touch soon.`})]}),(0,f.jsx)(`button`,{onClick:E,className:`premium-apply-btn`,style:{marginTop:`12px`},children:`Close Window`})]}):(0,f.jsxs)(f.Fragment,{children:[(0,f.jsxs)(`div`,{style:{marginBottom:`32px`},children:[(0,f.jsx)(`h2`,{style:{fontFamily:`var(--font-heading)`,fontSize:`2rem`,fontWeight:500,color:`#F5F2EC`,margin:`0 0 8px 0`},children:`Submit Your Application`}),(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`2px`},children:[(0,f.jsx)(`span`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.75rem`,fontWeight:600,letterSpacing:`1px`,color:`rgba(245, 242, 236, 0.45)`,textTransform:`uppercase`},children:`Applying for`}),(0,f.jsx)(`span`,{style:{fontFamily:`var(--font-sans)`,fontSize:`1.05rem`,fontWeight:500,color:`#C1121F`},children:t?t.title:`General Application`})]})]}),(0,f.jsxs)(`form`,{onSubmit:e=>{e.preventDefault();let t={};if(b.fullName.trim()||(t.fullName=`Full Name is required.`),b.email.trim()?/\S+@\S+\.\S+/.test(b.email)||(t.email=`Invalid email formatting.`):t.email=`Email Address is required.`,b.phone.trim()||(t.phone=`Phone Number is required.`),g||(t.file=`Please upload your CV/Resume.`),Object.keys(t).length>0){C(t);return}y(!0)},style:{display:`flex`,flexDirection:`column`,gap:`24px`},children:[(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,f.jsx)(`label`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:600,letterSpacing:`1.5px`,color:`rgba(245, 242, 236, 0.45)`,textTransform:`uppercase`},children:`Position Applied For`}),(0,f.jsx)(`input`,{type:`text`,className:`premium-input-field`,value:t?t.title:`General Application`,disabled:!0,style:{opacity:.6,cursor:`not-allowed`,backgroundColor:`rgba(255, 255, 255, 0.005) !important`}})]}),(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,f.jsx)(`label`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:600,letterSpacing:`1.5px`,color:`rgba(245, 242, 236, 0.45)`,textTransform:`uppercase`},children:`Full Name *`}),(0,f.jsx)(`input`,{type:`text`,placeholder:`e.g. Alexander Mercer`,className:`premium-input-field`,value:b.fullName,onChange:e=>O(`fullName`,e.target.value)}),S.fullName&&(0,f.jsx)(`span`,{style:{color:`#C1121F`,fontSize:`0.75rem`,fontFamily:`var(--font-sans)`},children:S.fullName})]}),(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,f.jsx)(`label`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:600,letterSpacing:`1.5px`,color:`rgba(245, 242, 236, 0.45)`,textTransform:`uppercase`},children:`Email Address *`}),(0,f.jsx)(`input`,{type:`email`,placeholder:`alexander@mercer.com`,className:`premium-input-field`,value:b.email,onChange:e=>O(`email`,e.target.value)}),S.email&&(0,f.jsx)(`span`,{style:{color:`#C1121F`,fontSize:`0.75rem`,fontFamily:`var(--font-sans)`},children:S.email})]}),(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,f.jsx)(`label`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:600,letterSpacing:`1.5px`,color:`rgba(245, 242, 236, 0.45)`,textTransform:`uppercase`},children:`Phone Number *`}),(0,f.jsx)(`input`,{type:`tel`,placeholder:`+971 50 123 4567`,className:`premium-input-field`,value:b.phone,onChange:e=>O(`phone`,e.target.value)}),S.phone&&(0,f.jsx)(`span`,{style:{color:`#C1121F`,fontSize:`0.75rem`,fontFamily:`var(--font-sans)`},children:S.phone})]}),(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,f.jsx)(`label`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:600,letterSpacing:`1.5px`,color:`rgba(245, 242, 236, 0.45)`,textTransform:`uppercase`},children:`Upload CV / Resume *`}),(0,f.jsxs)(`label`,{className:`premium-file-upload`,children:[(0,f.jsx)(`input`,{type:`file`,accept:`.pdf,.doc,.docx`,style:{display:`none`},onChange:D}),(0,f.jsx)(o,{size:18,style:{color:g?`#C1121F`:`rgba(245, 242, 236, 0.4)`}}),(0,f.jsx)(`span`,{style:{fontSize:`0.86rem`,color:g?`#F5F2EC`:`rgba(245, 242, 236, 0.6)`,fontWeight:500},children:g?g.name:`Select PDF, DOC, or DOCX`}),(0,f.jsx)(`span`,{style:{fontSize:`0.72rem`,color:`rgba(245, 242, 236, 0.3)`},children:`Max file size 5MB`})]}),S.file&&(0,f.jsx)(`span`,{style:{color:`#C1121F`,fontSize:`0.75rem`,fontFamily:`var(--font-sans)`,marginTop:`4px`},children:S.file})]}),(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,f.jsx)(`label`,{style:{fontFamily:`var(--font-sans)`,fontSize:`0.72rem`,fontWeight:600,letterSpacing:`1.5px`,color:`rgba(245, 242, 236, 0.45)`,textTransform:`uppercase`},children:`Cover Letter (Optional)`}),(0,f.jsx)(`textarea`,{rows:4,placeholder:`Tell us why you want to design luxury travel experiences with us...`,className:`premium-input-field`,style:{resize:`vertical`,minHeight:`100px`},value:b.coverLetter,onChange:e=>O(`coverLetter`,e.target.value)})]}),(0,f.jsx)(`button`,{type:`submit`,className:`glassy-submit-btn`,style:{marginTop:`8px`},children:`Submit Application`})]})]})]})})})]})}export{m as default};